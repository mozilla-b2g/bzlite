...
function createAttachmentRow(name) {
  var DEFAULT_CHECKED = [
    'dev-log-main.log', 'properties.log', 'system-b2g-application.ini',
    'logshake-screenshot.png', 'screenshot.png'
  ];
