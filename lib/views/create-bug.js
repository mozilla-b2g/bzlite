...
function showComponents() {
  ...
  _(app.bugzilla.getProducts.bind(app.bugzilla))({
    ...
    form.querySelector('#componentList').appendChild(frag);
    form.querySelector('#component').setAttribute('list', 'componentList');
  });
}
...
module.exports = function(ctx) {
  ...
  return tpl.read('/views/create_bug.tpl').then(function(_form) {
    ...
    form.querySelector('#cleanSummary')
      .addEventListener('click', function() {
        form.querySelector('#summary').value = '';
      });
    form.querySelector('#cleanDescription')
      .addEventListener('click', function() {
