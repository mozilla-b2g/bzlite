...
var AchievementsService = require('../achievements-service.js');

var app, form, bug, achievementsService;
...
function rewardAchievement() {
  ...
  achievementsService.reward({
    criteria: 'achievements/bug-buster',
    evidence: 'urn:bugzilla-lite:bug:created',
    name: 'Bug Buster',
    description: 'File a bug in Bugzilla Lite',
    image: './style/icons/bug-buster.png'
  });
}
...
function submitBug() {
  ...
  app.bugzilla.createBug({
    ...
    createAttachments();
  }).then(rewardAchievement).catch(function(e) {
